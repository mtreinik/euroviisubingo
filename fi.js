...
items = [
  ...
  "esitys huokuu itsetuhoisuutta",
  "naisen asu häivyttää kaiken naisellisuuden",
  "kilpavoimisteluasu",
  "todella intensiivinen katse",
  "kokovalkoinen asu tai lavaste",
  "etsitään jotakuta",
  "erikoisesta materiaalista tehty lavaste",
  "lavaa käytetty uudella tavalla",
  "todella lämpöiset vaatteet",
  "upea käsiliike",
  "lavalla jotain täysin outoa",
  "kimaltelevat vaatteet",
  "joku kantaa jotakuta",
  "silmänisku",
  "paholaisteema",
  ...
  "silmät peittävä asuste",
  "juontajalla sanat sekaisin tai jäätyminen",
  "ollaan yhtä isoa perhettä",
  "tekotaiteellinen",
  "kristinuskoviittaus",
  "esityksessä juostaan",
  "ilmastonmuutosteema",
  "mieletön kampaus",
  "lippua käytetään vaatteena tai vaatteessa",
  "jäätävät kengät",
